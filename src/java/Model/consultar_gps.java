...
public class consultar_gps {
    ...
    public consultar_gps(Integer no_serie, Integer id_modelo_gps, Integer id_unidad, String niv, Integer kilometraje, Date fecha_registro, Date fecha_actualizacion) {
