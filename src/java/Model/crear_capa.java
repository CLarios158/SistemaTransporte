 ...
 */
public class crear_capa {
    
    public crear_capa(Integer id_capa, String nombre, String Icon,Boolean statusCapa, String descripcion, Date fecha_registro, Date fecha_actualizacion) {
