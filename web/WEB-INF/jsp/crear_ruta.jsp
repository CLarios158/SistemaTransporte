...
<html lang="en">
    ...
    <body class="theme-dark">
        ...
        <main>
            <div style="width: 30%;" class="slide-menu main-slide-menu show" id="main-slide-menu">
                ...
                <nav class="nav nav-horizontal flex-row">
                    <a class="color-label" href="<c:url value="index.htm" />"><i class="fas fa-home color-icon"></i>Rutas |</a>
                    <a class="color-label-bold" href="<c:url value="crear_capa.htm" />" >Crear Ruta</a>
                </nav>
                <div class="card main-slide-menu-card">
                    <form name="myForm" onsubmit="return(validate());" method=POST enctype=multipart/form-data>
                        <div class="card-body">
                            ...
                            <div class="form-group row ">
                                <label for="capa" class="col-sm-4 col-form-label">Seleccione capa:</label>
                                <div class="col-sm-8">
        ...
        <!-- Validar si el nombre de la ruta existe -->
        <script type="text/javascript">
            function validarRuta(nombre) {
                var nombre = nombre.value;
                
                $.ajax({
                    url: 'validar_ruta.htm',
                    type: 'POST',
                    dataType: "json",
                    data: {
                        nombre: nombre
                    ...
                    success: function (data) {
                        ...
                        if(data.nombre){
                            document.getElementById("errorRuta").innerHTML = "La ruta se encuentra registrada.";
                            $("#errorRuta").show();
