...
<html lang="en">
    ...
    <body class="theme-dark">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(document).on('click', 'a[id=click-unidad]', function (e) {
                    ...
                    $("#buscarUnidad").val('');
                    var id = $(this).data("id");
                    document.getElementById("unidad").value = JSON.stringify(id);
        ...
        <!-- Validar si el nombre del itinerario existe -->
        <script type="text/javascript">
            function validarItinerario(nombre) {
                var nombre = nombre.value;
                
                $.ajax({
                    url: 'validar_itinerario.htm',
                    type: 'POST',
                    dataType: "json",
                    data: {
                        nombre: nombre
                    ...
                    success: function (data) {
                        ...
                        if(data.nombre){
                            document.getElementById("errorItinerario").innerHTML = "El itinerario se encuentra registrado.";
