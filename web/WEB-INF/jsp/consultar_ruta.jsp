...
<html lang="en">
    ...
    <body class="theme-dark">
        ...
        <main>
            <div style="width:  30%;" class="slide-menu main-slide-menu show" id="main-slide-menu">
                ...
                <nav class="nav nav-horizontal flex-row">
                    <a class="color-label" href="<c:url value="index.htm" />"><i class="fas fa-home color-icon"></i>Ruta |</a>
                    <a class="color-label-bold" href="<c:url value="consultar_ruta.htm" />" >Consultar Ruta</a>
                </nav>
                <div class="card main-slide-menu-card">
                    <div class="card-body">
                        <div id="buscar-ruta" class=" row">
                            <label class="col-sm-12" for="Buscar">Buscar ruta:</label>
                            <div class="col-sm-12 input-icons">
                                <i class="fas fa-search icon-input"></i>
                                <input type="text" class="form-control" name="buscarRuta" id="buscarRuta" autocomplete="off">
                        ...
                        <div id="editar-ruta" style="display: none;">
                            ...
                            <div class="form-group row">
                                <label for="ruta" class="col-sm-4 col-form-label">Capa asignada:</label>
                                <div class="col-sm-8">
                    ...
                    <div class="card-footer"> 
                        <div id="opciones-ruta" style="display: none;">
                        ...
                        <div id="guardar-ruta" class="center" style="display: none;">
        ...
        <!-- Modal Eliminar Capa-->
        <div class="modal fade" id="eliminarRuta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
            <div class="modal-dialog" role="document">
                <div style="color: #05151C;" class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col center"><h5 class="text-white">Eliminar Ruta</h5></div>
                        </div>
                        <div class="separator center"></div>
                        <div class="row">
        ...
        <script type = "text/javascript">
            ...
            $('#modalEliminar').click(function () {
                document.getElementById("rutaSeleccionada2").innerHTML = "&nbsp"+$("#ruta-seleccionada").val()+"?"; 
                $('#eliminarRuta').modal('show');
            });
        ...
        <!-- Cuando se de click en el boton Editar, se obtendran los datos de la ruta -->
        <script type = "text/javascript">
