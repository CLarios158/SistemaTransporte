        ...
        <main style="background-color: #05151C;">
            ...
            <div class="form-group">
                <nav class="nav nav-horizontal flex-row">
                    ...
                    <a class="color-label-bold" href="#" >Alertas</a>
                </nav>
                <div class="line"></div>
            </div>
            ...
            <div class="row" style="margin: 0px;">
                <div class="col right">
                    <table class="table-alerta">
                        <tr>
                            <th>Unidad</th>
                            <th></th>
                        </tr>
                        <tr>
                            <td class="ancho">Puntos de Control en los que se paró la unidad</td>
                            <td>3</td>
                        </tr>
                        <tr>
                            <td>Paradas obligatorias no autorizadas</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>Incumplimiento de tiempo</td>
                            <td>5</td>
                        </tr>
                        <tr>
                            <td>Incumplimiento de recorrido</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>Unidad fuera de ruta</td>
                            <td>0</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="border: none;">Unidad fuera de conexión</td>
                ...
                <div class="col" >
                    <table class="table-alerta">
                        ...
                        <tr>
                            <td>Alcancía fuera de conexión</td>
                            <td>0</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Detección de tarjeta en lista negra</td>
                            <td>1</td>
                        </tr>
                        <tr>
                            <td>Término de papel térmico</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>Pago excesivo de pasajes con una misma tarjeta</td>
                            <td>2</td>
                        </tr>
                        <tr >
                            <td>Alcancía por llenarse</td>
                            <td>0</td>
                        </tr>
                        <tr>
